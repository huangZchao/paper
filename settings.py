...
flags.DEFINE_list('hidden3', [64, 32, 16], 'Number of units in TCN.')
...
flags.DEFINE_float('time_decay', 0.1, 'decay for each step.')
flags.DEFINE_float('alpha', 10, 'contribution of structural loss.')


def get_settings(dataname, seq_len):
